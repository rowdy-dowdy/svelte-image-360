...
<div class="h-full flex bg-white">
  <div class="p-4 border-r flex flex-col space-y-6">
    ...
    <a href="/admin" class="icon w-10 h-10 rounded-xl p-1.5 hover:bg-gray-200 border-2 border-transparent 
      {$page.url.pathname.includes("/admin") ? '!border-gray-800' : ''}"
    >
    ...
    <a href="/logs" class="icon w-10 h-10 rounded-xl p-1.5 hover:bg-gray-200 border-2 border-transparent 
      {$page.url.pathname.includes("/admin/logs") ? '!border-gray-800' : ''}"
    >
    ...
    <a href="/settings" class="icon w-10 h-10 rounded-xl p-1.5 hover:bg-gray-200 border-2 border-transparent 
      {$page.url.pathname.includes("/admin/settings") ? '!border-gray-800' : ''}"
    >
